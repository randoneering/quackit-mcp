...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--database-path", type=Path, default=None, help="Path to DuckDB database file")
...
def main() -> int:
    ...
    try:
        ...
        if args.command == "serve":
            ...
            host = validate_transport_binding(args.transport, args.host, args.allow_network)
